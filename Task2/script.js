document.addEventListener("DOMContentLoaded", function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const ratingsToggle = document.querySelector(".filter-header.ratings-toggle");
    const filterBox = ratingsToggle.closest(".filter-box");

    ratingsToggle.addEventListener("click", function () {
      filterBox.classList.toggle("open");

      // Optional: toggle dropdown icon (up/down)
      const icon = filterBox.querySelector(".dropdown-icon");
      if (filterBox.classList.contains("open")) {
        icon.src = "assets/images/dropup.png";
      } else {
        icon.src = "assets/images/dropdown.png";
      }
    });
  });
